...
(defun dotspacemacs/layers ()
  (setq-default
   ...
   dotspacemacs-additional-packages '(parinfer flycheck-clojure gist)
...
(defun dotspacemacs/user-config ()
  ...
  (setq-default
   ...
   parinfer-extensions '(defaults pretty-parens evil)

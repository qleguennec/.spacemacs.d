...
This function is called at the very end of Spacemacs initialization."
  ...
  (custom-set-faces
   ...
   ;; Your init file should contain only one such instance.
   ;; If there is more than one, they won't work right.
   ;; '(default ((nil (:foreground "#f8f8f8" :background "#26292c"))))
   ;;'(ahs-face ((nil (:background "#26292c" :foreground "#db208a"))))))
   ;; '(ahs-plugin-whole-buffer-face ((nil (:background "#26292c" :foreground "#db208a" :underline t))))
   ;;'(font-lock-string-face ((nil (:foreground "#e38837"))))))
   ;;'(powerline-active1 ((t (:background "#5984b8" :foreground "#ffffff"))))))
                                        ; '(powerline-inactive1 ((nil (:foreground "#95abdb"))))
   ;; '(powerline-inactive2 ((nil (:background "#2a2e38"))))
